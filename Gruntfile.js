...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        less: {
            scripts: {
                files: {
                    '<%= yeoman.dist %>/asset/css/main.css': '<%= yeoman.app %>/asset/css/main.less'
                }
            }
        },
                    ...
                    middleware: function(connect, options, middlewares) {
                        ...
                        middlewares.unshift(
                            ...
                            function(req, res, next) {
                                if (!/request.ajax\?path/.test(req.url)) {
                                    return next();
                                }
                                var util = require('./app/mock/util');
                                var path = req.body.path;
                                path = path.indexOf('/') === 0 ? './app/mock' + path : './app/mock/' + path;
                                var mock = require(path);
                                res.end(JSON.stringify(mock.index(req.body, util)));
                            }
                        );
                        return middlewares;
                    }
        ...
        jshint: {
            ...
            all: [
                ...
                '<%= yeoman.app %>/mock/{,*/}*.js',
                'test/spec/{,*/}*.js',
                // commonUI模块涉及后续全部重写，暂时不过jshint
                '!<%= yeoman.app %>/asset/common/commonUI/*/*.js',
                // 下面这仨是老模块迁移，所以暂时不过jshint了
                '!<%= yeoman.app %>/asset/common/esUI/*.js',
                '!<%= yeoman.app %>/asset/budget/**/*.js',
                '!<%= yeoman.app %>/asset/common/ui.js'
            ]
        },
        ...
        requirejs: {
            options: {
                paths: {
                    ...
                    'bootstrap-dropdown': '../dep/commonui/dropdown/index',
                    'bootstrap-carousel': '../dep/commonui/carousel/index',
                    'datetimepicker': '../dep/commonui/datetimepicker/index',
                    'daterangepicker': '../dep/commonui/daterangepicker/index',
                    'segmentedProgressBar': 'common/ui-plugin/segmentedProgressBar'
                },
                packages: [{
                    'name': 'mini-event',
        ...
        replace: {
            ...
            mainHtml: {
                ...
                files: {
                    '<%= yeoman.dist %>/home.html': '<%= yeoman.dist %>/home.html'
                }
            }
        },
            ...
            requirejsTmp: {
                files: [{
                    ...
                    src: [
                        ...
                        '!mock/**',
                        '!dep/**',
                        'dep/requirejs-text/text.js',
                        'dep/jquery/jquery.js',
                        'dep/sammy/lib/sammy.js',
